...
const CreateBatchForm = () => {
    ...
    const handleSubmit = () =>{
        ...
        fetch("http://127.0.0.1:8000/batches/create/", requestOptions)
        .then((response) => response.json())
        .then((result) => {
            if(result.batch_no){
                toast.current.show({ severity: 'success', summary: 'Success', detail: 'You have successfully created a batch' });
            }
        })
