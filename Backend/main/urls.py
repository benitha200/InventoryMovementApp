...
urlpatterns = [
    ...
    path('roles/create/', RolesCreateAPIView.as_view(), name='roles'),
    ...
    path('production-approvals/',ProductionApprovalAPIView.as_view(),name='production-approvals'),
    path('approve-production/',ProductionInApproveAPIView.as_view(),name='approve-production'),
    ...
    path('production-batch-details-after-completion/',ProductionBatchDetailsAfterCompletion.as_view(), name="production-batch-details"),
    ...
    path('production-outputs/',ProductionOutputsListView.as_view(),name='production Outputs'),
